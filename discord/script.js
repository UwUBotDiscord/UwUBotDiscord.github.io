(function(fetcher) {
  ...
  embedAdd.addEventListener("click", function() {
    ...
    embeds.append('<div data-embed="' + nowEmbed + '">\
          ...
          <div hidden class="inlblock">\
            <label for="author">Author</label>\
            <input type="text" name="author" maxlength="256"/>\
          </div>\
          <div hidden class="inlblock" style="margin-left: 40px;">\
            <label for="authoricon">Author Icon URL</label>\
            <input type="url" name="authoricon" class="inlblock" style="width: 20em;"/>\
          </div>\
          <label hidden for="authorurl">Author Clickable URL</label>\
          <input hidden type="url" name="authorurl" style="width: 20em;"/>\
          <label hidden for="thumbnail">Thumbnail URL</label>\
          <input hidden type="url" name="thumbnail" style="width: 20em;"/>\
          ...
          <div class="inlblock">\
            ...
            <input type="url" name="footericon"/>\
          </div>\
  ...
  send.addEventListener("click", function() {
    ...
    if (/@everyone/i.test(content)) return alert("Message cannot contain @everyone");
    if (/@here/i.test(content)) return alert("Message cannot contain @here");
    if (/@/i.test(content)) return alert("Message cannot contain @");
