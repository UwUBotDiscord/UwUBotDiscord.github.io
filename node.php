...
define("ADMIN_MODE", start); //set to true to allow unsafe operations, set back to false when finished
...
function node_start($file) {
	...
	$node_pid = exec("PORT=" . NODE_PORT . "/home4/uwubotor/public_html/bin/node" . "$file >nodeout 2>&1 & echo $!");
